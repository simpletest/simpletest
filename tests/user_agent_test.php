...
class TestOfFetchingUrlParameters extends UnitTestCase
{
    ...
    public function testGetRequestWithoutIncidentGivesNoErrors(): void
    {
...
{
    public function testAdditionalHeaderAddedToRequest(): void
    {
...
{
    public function testCookieJarIsSentToRequest(): void
    {
    ...
    public function testNoCookieJarIsSentToRequestWhenCookiesAreDisabled(): void
    {
        $request = new MockSimpleHttpRequest;
        $request->returns('fetch', $this->createStandardResponse());
    ...
    public function testReadingNewCookie(): void
    {
    ...
    public function testIgnoringNewCookieWhenCookiesDisabled(): void
    {
        $request = $this->createCookieSite('Set-cookie: a=AAAA');
        $agent   = $this->createMockedRequestUserAgent($request);
        $agent->ignoreCookies();
    ...
    public function testOverwriteCookieThatAlreadyExists(): void
    {
        $request = $this->createCookieSite('Set-cookie: a=AAAA');
        $agent   = $this->createMockedRequestUserAgent($request);
        $agent->setCookie('a', 'A');
    ...
    public function testClearCookieBySettingExpiry(): void
    {
    ...
    public function testAgeingAndClearing(): void
    {
    ...
    public function testReadingIncomingAndSettingNewCookies(): void
    {
...
class TestOfHttpRedirects extends UnitTestCase
{
    ...
    public function testDoubleRedirect(): void
    {
        $agent = new MockRequestUserAgent;
        $agent->returnsAt(
            0,
    ...
    public function testSuccessAfterRedirect(): void
    {
        $agent = new MockRequestUserAgent;
        $agent->returnsAt(
            0,
    ...
    public function testRedirectChangesPostToGet(): void
    {
        $agent = new MockRequestUserAgent;
        $agent->returnsAt(
            0,
...
{
    public function testUntestedHost(): void
    {
...
{
    public function testAuthenticateHeaderAdded(): void
    {
        $response    = new MockSimpleHttpResponse;
        $mockHeaders = new MockSimpleHttpHeaders;
        $response->returnsByReference('getHeaders', $mockHeaders);
