...
{
    public function testTitleReadFromFramesetPage(): void
    {
    ...
    public function testHeadersReadFromFramesetByDefault(): void
    {
        $page = new MockSimplePage;
    ...
    public function testEmptyFramesetHasNoContent(): void
    {
        $page = new MockSimplePage;
    ...
    public function testRawContentIsFromOnlyFrame(): void
    {
        $page = new MockSimplePage;
    ...
    public function testRawContentIsFromAllFrames(): void
    {
        $page = new MockSimplePage;
        $page->expectNever('getRaw');
    ...
    public function testTextContentIsFromOnlyFrame(): void
    {
        $page = new MockSimplePage;
    ...
    public function testTextContentIsFromAllFrames(): void
    {
        $page = new MockSimplePage;
        $page->expectNever('getText');
    ...
    public function testFieldFoundIsFirstInFramelist(): void
    {
        $frame1 = new MockSimplePage;
    ...
    public function testFrameReplacementByIndex(): void
    {
        $page = new MockSimplePage;
        $page->expectNever('getRaw');
    ...
    public function testFrameReplacementByName(): void
    {
        $page = new MockSimplePage;
        $page->expectNever('getRaw');
...
{
    public function testStartsWithoutFrameFocus(): void
    {
        $page     = new MockSimplePage;
        $frameset = new SimpleFrameset($page);
    ...
    public function testCanFocusOnSingleFrame(): void
    {
        $page = new MockSimplePage;
        $page->expectNever('getRaw');
    ...
    public function testContentComesFromFrameInFocus(): void
    {
        $page = new MockSimplePage;
    ...
    public function testCanFocusByName(): void
    {
        $page = new MockSimplePage;
...
class TestOfFramesetPageInterface extends UnitTestCase
{
    ...
    public function assertListInAnyOrder($list, $expected): void
    {
        \sort($list);
        \sort($expected);
    ...
    public function testFramsetHasPageInterface(): void
    {
        $difference = [];

        foreach ($this->page_interface as $method) {
            if (!\in_array($method, $this->frameset_interface, true)) {
    ...
    public function testHeadersReadFromFrameIfInFocus(): void
    {
        $frame = new MockSimplePage;
    ...
    public function testUrlsComeFromBothFrames(): void
    {
        $page = new MockSimplePage;
    ...
    public function testLabelledUrlsComeFromBothFrames(): void
    {
        $frame1 = new MockSimplePage;
        $frame1->returnsByValue(
            'getUrlsByLabel',
    ...
    public function testUrlByIdComesFromFirstFrameToRespond(): void
    {
        $frame1 = new MockSimplePage;
    ...
    public function testReadUrlsFromFrameInFocus(): void
    {
        $frame1 = new MockSimplePage;
    ...
    public function testReadFrameTaggedUrlsFromFrameInFocus(): void
    {
        $frame = new MockSimplePage;
    ...
    public function testFindingFormsById(): void
    {
        $frame = new MockSimplePage;
    ...
    public function testFindingFormsBySubmit(): void
    {
        $frame = new MockSimplePage;
        $form  = new MockSimpleForm;
        $frame->returns(
    ...
    public function testFindingFormsByImage(): void
    {
        $frame = new MockSimplePage;
        $form  = new MockSimpleForm;
        $frame->returns(
    ...
    public function testSettingAllFrameFieldsWhenNoFrameFocus(): void
    {
        $frame1 = new MockSimplePage;
    ...
    public function testOnlySettingFieldFromFocusedFrame(): void
    {
        $frame1 = new MockSimplePage;
    ...
    public function testOnlyGettingFieldFromFocusedFrame(): void
    {
        $frame1 = new MockSimplePage;
    ...
    private function getPageMethods()
    {
        ...
        foreach (\get_class_methods('SimplePage') as $method) {
            ...
            if (\in_array($method, ['setTitle', 'setBase', 'setForms', 'normalise', 'setFrames', 'addLink'], true)) {
                continue;
            }
            $methods[] = $method;
        }
