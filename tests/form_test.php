...
class TestOfForm extends UnitTestCase
{
    ...
    public function testTextWidgetById(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleTextTag(
    ...
    public function testTextWidgetByLabel(): void
    {
        $form   = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
    ...
    public function testSubmitWithAdditionalParameters(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('http://host'));
        $form->addWidget(new SimpleSubmitTag(
    ...
    public function testSubmitButtonWithLabelOfSubmit(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('http://host'));
        $form->addWidget(new SimpleSubmitTag(
    ...
    public function testSubmitButtonWithWhitespacePaddedLabelOfSubmit(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('http://host'));
        $form->addWidget(new SimpleSubmitTag(
            ['type' => 'submit', 'name' => 'test', 'value' => ' Submit '],
    ...
    public function testImageSubmitButton(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
    ...
    public function testImageSubmitButtonWithAdditionalData(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleImageSubmitTag([
            'type' => 'image',
    ...
    public function testButtonTag(): void
    {
        $form   = new SimpleForm(new SimpleFormTag([]), $this->page('http://host'));
    ...
    public function testMultipleFieldsWithSameNameSubmitted(): void
    {
        $form  = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
    ...
    public function testSingleSelectFieldSubmitted(): void
    {
        $form   = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
    ...
    public function testSingleSelectFieldSubmittedWithPost(): void
    {
    ...
    public function testSingleUncheckedRadioButton(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
    ...
    public function testSingleCheckedRadioButton(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleRadioButtonTag(
    ...
    public function testUncheckedRadioButtons(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleRadioButtonTag(
            ['name' => 'me', 'value' => 'a', 'type' => 'radio'],
    ...
    public function testCheckedRadioButtons(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleRadioButtonTag(
            ['name' => 'me', 'value' => 'a', 'type' => 'radio'],
    ...
    public function testMultipleFieldsWithSameKey(): void
    {
        $form = new SimpleForm(new SimpleFormTag([]), $this->page('htp://host'));
        $form->addWidget(new SimpleCheckboxTag(
    ...
    public function testRemoveGetParamsFromAction(): void
    {
