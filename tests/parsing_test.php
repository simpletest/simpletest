...
abstract class TestOfParsing extends UnitTestCase
{
    ...
    public function testTextAccessor(): void
    {
    ...
    public function testAddAbsoluteLink(): void
    {
    ...
    public function testUrlLabelsHaveHtmlTagsStripped(): void
    {
        $page = $this->whenVisiting(
            'http://host',
    ...
    public function testAddStrictRelativeLink(): void
    {
        $page = $this->whenVisiting(
            'http://host',
    ...
    public function testAddBareRelativeLink(): void
    {
        $page = $this->whenVisiting(
            'http://host',
            '<html><a href="somewhere.php">Label</a></html>',
    ...
    public function testAddRelativeLinkWithBaseTag(): void
    {
    ...
    public function testAddAbsoluteLinkWithBaseTag(): void
    {
        $raw = '<html><head><base href="http://www.lastcraft.com/stuff/"></head>' .
    ...
    public function testCanFindLinkInsideForm(): void
    {
    ...
    public function testCanGetLinksByIdOrLabel(): void
    {
    ...
    public function testCanFindLinkByNormalisedLabel(): void
    {
    ...
    public function testCanFindLinkByImageAltText(): void
    {
    ...
    public function testTitleWithEntityReference(): void
    {
        $page = $this->whenVisiting(
            'http://host',
    ...
    public function testCanReadElementOfUnclosedForm(): void
    {
        $raw = '<html><head><form>' .
                '<input type="text" name="here" value="Hello">' .
                '</head></html>';
    ...
    public function testCanReadElementByLabel(): void
    {
        $raw = '<html><head><form>' .
    ...
    public function testCanFindFormByLabel(): void
    {
    ...
    public function testConfirmSubmitAttributesAreCaseSensitive(): void
    {
    ...
    public function testCanFindFormByImage(): void
    {
        $raw = '<html><head><form>' .
    ...
    public function testCanFindFormByButtonTag(): void
    {
        $raw = '<html><head><form>' .
    ...
    public function testCanFindFormById(): void
    {
    ...
    public function testUnparsedTagDoesNotCrash(): void
    {
        $raw = '<form><input type="reset" name="Clear"></form>';
        $this->whenVisiting('http://host', $raw);
    }

    public function testReadingTextField(): void
    {
        $raw = '<html><head><form>' .
    ...
    public function testEntitiesAreDecodedInDefaultTextFieldValue(): void
    {
    ...
    public function testReadingTextFieldIsCaseInsensitive(): void
    {
        $raw = '<html><head><FORM>' .
                '<INPUT TYPE="TEXT" NAME="a">' .
                '<INPUT TYPE="TEXT" NAME="b" VALUE="bbb" id=3>' .
    ...
    public function testSettingTextField(): void
    {
        $raw = '<html><head><form>' .
                '<input type="text" name="a">' .
    ...
    public function testSettingTextFieldByEnclosingLabel(): void
    {
        $raw = '<html><head><form>' .
                '<label>Stuff' .
    ...
    public function testGettingTextFieldByEnclosingLabelWithConflictingOtherFields(): void
    {
        $raw = '<html><head><form>' .
                '<label>Stuff' .
                '<input type="text" name="a" value="A">' .
    ...
    public function testSettingTextFieldByExternalLabel(): void
    {
        $raw = '<html><head><form>' .
    ...
    public function testEntitiesAreDecodedInTextareaValue(): void
    {
    ...
    public function testSelectionOptionsAreNormalised(): void
    {
        $raw = '<form>' .
                '<select name="a">' .
    ...
    public function testCanParseBlankOptions(): void
    {
        $raw = '<form>
                <select id=4 name="d">
    ...
    public function testTwoSelectionFieldsAreIndependent(): void
    {
        $raw = '<form>
                    <select id=4 name="d">
    ...
    public function testEmptyOptionDoesNotScrewUpTwoSelectionFields(): void
    {
        $raw = '<form>
                    <select name="d">
                        <option value="d1" selected>D1</option>
    ...
    public function testSettingSelectionFieldByEnclosingLabel(): void
    {
        $raw = '<form>' .
                '<label>Stuff' .
    ...
    public function testTwoSelectionFieldsWithLabelsAreIndependent(): void
    {
        $raw = '<form>
                    <label>Labelled D
                        <select id=4 name="d">
    ...
    public function testSettingRadioButtonByEnclosingLabel(): void
    {
        $raw = '<form>' .
    ...
    public function testCanParseInputsWithAllKindsOfAttributeQuoting(): void
    {
        $raw = '<form>' .
    ...
    public function assertSameFrameset($actual, $expected): void
    {
        $this->assertIdentical(
...
class TestOfParsingUsingPhpParser extends TestOfParsing
{
    ...
    public function testNastyTitle(): void
    {
        $page = $this->whenVisiting(
            'http://host',
    ...
    public function testSetFieldValueByLabelWithForAttribute(): void
    {
        $label = 'justLabel';
        $value = 'another stuff';
