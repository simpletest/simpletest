<?php
    ...
    class SimpleTestCase extends RunnableTest {
        ...
        function assertTrue($result, $message = "True assertion failed.") {
            $this->_current_runner->notify(new TestResult($result, $message));
        }
        ...
        function dump($variable, $message = false) {
            ...
            $this->_current_runner->notify(new FormattedTestMessage($formatted));
        }
        ...
        function sendMessage($message) {
            $this->_current_runner->notify(new TestMessage($message));
        }
    }
