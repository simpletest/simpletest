...
class SeleneseTestCase extends UnitTestCase
{
     ...
     * @param string $param2
     */
    public function assertFunction($function, $param1, $param2): void
    {
        ...
        if (!\in_array($function, $_verifyMap, true)) {
            $reponse = \substr($reponse, 0, 2) === 'OK';
        }
     ...
     */
    public function launch($html = ''): void
    {
        $this->html = $html;
        $this->tidy();
        $this->parse();
        ...
        foreach ($this->parsed_table as $test) {
            if (\in_array($test[0], $this->_commandMap, true)) {
     ...
     * @param string $file
     */
    public function launchPhpFile($file): void
    {
        \ob_start();
     ...
     * @param string $testFile
     */
    public function launchFile($testFile): void
    {
